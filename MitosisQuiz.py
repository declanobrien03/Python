...
checkAnswerButton = Button(window, text="Check Answers", font="Helvetica 18",\
                     fg="white", activeforeground="white", command=checkAnswer,\
